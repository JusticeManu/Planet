...
app.get("/mars", async (req, res, next) => {
  try {
    let url =
      "https://api.unsplash.com/search/photos?query=mars&per_page=7&client_id=SouHY7Uul-OxoMl3LL3c0NkxUtjIrKwf3tsGk1JaiVo";
    let response = await fetch(url);
...
app.get("/jupiter", async (req, res, next) => {
  try {
    let url =
      "https://api.unsplash.com/search/photos?query=jupiter&per_page=10&client_id=SouHY7Uul-OxoMl3LL3c0NkxUtjIrKwf3tsGk1JaiVo";
    let response = await fetch(url);
    const data = await response.json();
...
app.get("/saturn", async (req, res, next) => {
  try {
    let url =
      "https://api.unsplash.com/search/photos?query=saturn&per_page=7&client_id=SouHY7Uul-OxoMl3LL3c0NkxUtjIrKwf3tsGk1JaiVo";
    let response = await fetch(url);
    const data = await response.json();
...
app.get("/uranus", async (req, res, next) => {
  try {
    let url =
      "https://api.unsplash.com/search/photos?query=uranus&per_page=3&client_id=SouHY7Uul-OxoMl3LL3c0NkxUtjIrKwf3tsGk1JaiVo";
    let response = await fetch(url);
    const data = await response.json();
...
app.get("/neptune", async (req, res, next) => {
  try {
    let url =
      "https://api.unsplash.com/search/photos?query=neptune&per_page=4&client_id=SouHY7Uul-OxoMl3LL3c0NkxUtjIrKwf3tsGk1JaiVo";
    let response = await fetch(url);
    const data = await response.json();
...
app.get("/pluto", async (req, res, next) => {
  try {
    let url =
      "https://api.unsplash.com/search/photos?query=pluto&per_page=2&client_id=SouHY7Uul-OxoMl3LL3c0NkxUtjIrKwf3tsGk1JaiVo";
    let response = await fetch(url);
    const data = await response.json();
